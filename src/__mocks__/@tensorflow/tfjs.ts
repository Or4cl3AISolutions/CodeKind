...
export const tensor1d = vi.fn((values?: any) => ({
...
export const mul = vi.fn((a: any, b: any) => tensor1d(a.dataSync())); // Simplified mock
export const relu = vi.fn((tensor: any) => tensor);
export const sigmoid = vi.fn((tensor: any) => tensor);
export const sub = vi.fn((a: any, b: any) => tensor1d(a.dataSync()));
export const mean = vi.fn((tensor: any) => ({ dataSync: vi.fn(() => [0.5]) })); // Mock mean
export const abs = vi.fn((tensor: any) => tensor);
export const grad = vi.fn((f: (t: any) => any) => vi.fn((t_val: any) => tensor1d([1,1,1]))); // Mock grad
